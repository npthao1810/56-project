    ...
    <div className="min-h-screen pb-20 font-serif">
      ...
      <main className="max-w-md mx-auto p-4 animate-in slide-in-from-bottom-4 duration-500 pb-24">
        ...
        {activeTab === 'bingo' && (
          <div className="transition-all duration-500">
            <div className="text-center mb-4">
              <h2 className="text-2xl font-bold text-slate-800 mb-1 font-serif">Journey to Thaoxinh 👑</h2>
              <p className="text-slate-500 text-sm font-medium">How many countries you can pass to meet your princess?</p>
            </div>
        ...
        {activeTab === 'mountain' && (
          <div className="transition-all duration-500">
            <div className="text-center mb-4">
              <h2 className="text-2xl font-bold text-slate-800 mb-1 font-serif">The 2 years Mountain 🏔️</h2>
              <p className="text-slate-500 text-sm font-medium">Help Thaibeo carry the Princess to the top!</p>
            </div>
            <MountainSection gameState={gameState} claimReward={claimReward} resetWeight={resetWeight} />
          </div>
        )}
      </main>
