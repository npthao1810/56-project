      ...
      <div className="bg-[#FFFAF0] w-full max-w-sm rounded-[2rem] shadow-[0_20px_50px_rgba(244,114,182,0.3)] border-2 border-amber-100 overflow-hidden animate-in zoom-in-95 duration-500">
        ...
        <div className="p-6 pt-5 bg-[url('https://www.transparenttextures.com/patterns/beige-paper.png')] relative">
          ...
          <div className="text-sm text-slate-600 space-y-3 leading-relaxed text-center font-medium font-serif italic mb-6">
            <p>
              Once upon a time, Princess Thaoxinh found herself stranded at the bottom of the Great Reward Mountain.
            </p>
            <p>
              The peak holds beautiful treasures, but the climb is far too steep! Only her true boyfriend, the legendary Thaibeo, can carry her to the top.
            </p>
            <p className="text-pink-600 font-bold">
              But alas, he is currently too small!
            </p>
            <p>
              Verify his identity in the Boyfriend Verification Trial, and help him travel the world to gain enough strength to carry her!
            </p>
          </div>
